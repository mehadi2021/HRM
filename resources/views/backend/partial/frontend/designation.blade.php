...
<table class="table table-striped">
  ...
  <tbody>
    <tr>
      ...
      <td>{{$data->designation_status}}</td>
      <td>
        <a href="{{route('designation.designation_edit',$data->id)}}" class="btn btn-info" role="button">Edit</a>
        <a href="{{route('designation.designation_delete',$data->id)}}" class="btn btn-danger" role="button">Delete</a>
      </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('_designation')}}" method="post">
          @csrf
