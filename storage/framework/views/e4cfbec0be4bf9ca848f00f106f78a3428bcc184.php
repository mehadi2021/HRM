                ...
                <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            ...
                            <a href="<?php echo e(route('place.job',$job->id)); ?>" class="btn btn-success"> Job Details</a>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spring-2023\hr-management-system\resources\views/frontend/fixed/job-circular.blade.php ENDPATH**/ ?>