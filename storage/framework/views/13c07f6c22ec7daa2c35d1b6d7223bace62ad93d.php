...
<table class="table table-striped">
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo e($data->department_id); ?></td>
      <td><?php echo e($data->action); ?></td>
    
      <td>
        <a href="<?php echo e(route('department.department_edit',$data->id)); ?>" class="btn btn-info" role="button">Edit</a>
        <a href="<?php echo e(route('department.department_delete',$data->id)); ?>" class="btn btn-danger" role="button">Delete</a>
      </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo e(route('_department')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.partial.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spring-2023\hr-management-system\resources\views/backend/partial/frontend/department.blade.php ENDPATH**/ ?>